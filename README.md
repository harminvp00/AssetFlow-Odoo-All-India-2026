...
> [!NOTE]
> As explicitly requested, Docker configuration and deployment options (e.g. `Dockerfile.client`, `Dockerfile.server`, `docker-compose.yml`, `docker-compose.dev.yml`) **have been omitted** to simplify local development setups.
